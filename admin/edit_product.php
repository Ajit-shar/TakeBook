                    ...
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            ...
                            <div>
                                ...
                                <input type="text" name="rent_price" value="<?php echo htmlspecialchars($row['rent_price']); ?>"
                                    required>
                            </div>
                            <div>
                            ...
                            <div>
                                <label>Product Semester</label>
                                <select name="semester_id" required>
                                    <option value="">Select Semester</option>
                                    <?php
                                    $sql_s = "SELECT * FROM semester";
                                    $result_s = $conn->query($sql_s);
                                    if ($result_s->num_rows > 0) {
                                        while ($row_s = $result_s->fetch_assoc()) {
                                            echo '<option value="' . $row_s['id'] . '" ' . ($row_s['id'] == $row['semester_id'] ? 'selected' : '') . '>' . htmlspecialchars($row_s['name']) . '</option>';
                                        }
                                    }
                                    ?>
                                </select>
